...
/*
	receiptDetailSearchList.php - This procedure instantiates a searchList component
					for the receiptDetail resource.  
					
					The searchList component will accept a search value and make a 
					GET request to the receiptDetail REST API for data filtered by that 
					search value.  It will respond with an HTML list with a subset of 
					the resulting data.
 */


$restURL = "/receiptDetail/rest/receiptDetail.php/receiptDetail";
