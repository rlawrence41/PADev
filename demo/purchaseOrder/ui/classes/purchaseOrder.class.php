...
/*
 *	purchaseOrder.class.php - These classes are specific to the purchaseOrder resource.
 */

// Define a page component.
class purchaseOrderPage extends page {
	...
	public function __construct() {
		...
		$form = new purchaseOrderForm("purchaseOrderForm", "adminForm", "purchaseOrder");
		$this->addChild($form); 
...
class purchaseOrderTable extends table {
	...
	public function __construct() {
		...
		parent::__construct("purchaseOrder", "id", "Purchase Orders");

		// It is generally not advisable to include the primary key field in the table.
#		$this->addColumn("id","purchaseOrder Number");	// No need to show in the table.

		// Syntax: $obj->addColumn(<columnName>:string, [<column header>]:string, [<description>]:string);
		
		/* Sample columns for a table...		
		$this->addColumn("purchaseOrder_id","purchaseOrder Id", "A short, memorable name for the account");
...
class purchaseOrderForm extends form {
	...
	public function __construct(...$args) {
		...
		$fieldGroup->addField("hidden", "id", 	"purchaseOrder Id", "");
