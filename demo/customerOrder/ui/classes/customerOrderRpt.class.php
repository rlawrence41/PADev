...
/*
 *	customerOrderRpt.class.php - This is the invoice report for the customer
 *	order transaction.
 *
 */
...
class customerOrderRptPage extends reportPage {
	
	public function __construct() {
		
		parent::__construct("customerOrder", 
							"customerOrderRptPage", 
							"Invoice Report",
							"A customer order suitable for printing.");
		...
		$report = new customerOrderReport();
...
class customerOrderReport extends report {
	...
	public function __construct() {
		...
		parent::__construct("customerOrder",
							...
							"Invoice report suitable for printing and sending to customers");
		...
		$header->template = "customerOrderGroupHeader.html";
		$summary->template = "customerOrderGroupSummary.html";
		...
		$group->addGroupField("invoiceNo", "Invoice Suffix");
