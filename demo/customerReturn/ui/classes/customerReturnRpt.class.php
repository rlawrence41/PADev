...
/*
 *	customerReturnRpt.class.php - This is the report for the customer return
 *	transaction.
 *
 */
...
class customerReturnRptPage extends reportPage {
	
	public function __construct() {
		
		parent::__construct("customerReturn", 
							"customerReturnRptPage", 
							"Customer Return Report",
							"A customer return document suitable for printing.");
...
class customerReturnReport extends report {
	...
	public function __construct() {
		...
		parent::__construct("customerReturn",
							"id", 
							"Customer Return Report", 
							"Return report suitable for printing and sending to customers");
		...
		$header->template = "customerReturnGroupHeader.html";
		$summary->template = "customerReturnGroupSummary.html";
