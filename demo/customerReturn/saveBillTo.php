...
/*
	...
	Updating the billing contact in a customer return kicks off several things--requiring 
...
include_once ("crCommon.php");
	

function updateBillTo(){

	// Grab the parent key and bill to contact id from the querystring.
...
#	$orderStr = print_r($orderData, true);
#	debug_msg("OrderData: {$orderStr}", true, "saveBillTo()");
