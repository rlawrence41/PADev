...
/*
	appliedItemSearchList.php - This procedure instantiates a searchList component
					for the appliedItem resource.  
					
					The searchList component will accept a search value and make a 
					GET request to the appliedItem REST API for data filtered by that 
					search value.  It will respond with an HTML list with a subset of 
					the resulting data.
 */


$searchList = new searchList("id", "appliedItem");
